import { normalizeEvidenceTimestampToTranscriptFormat } from '@/tools/youtube-analyzer/lib/transcript-timestamps';
import type { AnalyzedVideo, ChannelAnalysis, TranscriptSegment, VideoTranscriptAnalysis } from '@/tools/youtube-analyzer/types/analysis';
import { normalizeWhitespace, safeRatio } from '@/tools/youtube-analyzer/lib/utils';
import { AppError } from '@/tools/youtube-analyzer/server/errors';
import { llmTranscriptAnalysisSchema, type ParsedLlmTranscriptAnalysis } from '@/tools/youtube-analyzer/server/llm/transcript-analysis-schema';
